<?php include 'filesLogicToan.php';?>
<!DOCTYPE html>
<html lang="en">
 <head>
     <meta charset="UTF-8">
     ...
     <div class = "row">
        <aside class="col-sm-2">
          ...
          <article class="col-sm-10" >
		      ...
		      <div class="row">
		        <form action="montoan.php" method="post" enctype="multipart/form-data" >
		          <h3><center><b> Upload File Môn Toán </b></center></h3>
				...
				<tbody style="font-size: 15px">
				  <?php foreach ($files as $file): ?>
				    <tr>
				      ...
				      <td><a href="montoan.php?file_id=<?php echo $file['id'] ?>">Download</a></td>
				    </tr>
				  <?php endforeach;?>
