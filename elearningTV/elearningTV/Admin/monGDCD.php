<?php include 'filesLogicGDCD.php';?>
<!DOCTYPE html>
<html lang="en">
 <head>
     <meta charset="UTF-8">
     ...
     <div class = "row">
        <aside class="col-sm-2">
          ...
          <article class="col-sm-10" >
		      ...
		      <div class="row">
		        <form action="monGDCD.php" method="post" enctype="multipart/form-data" >
		          <h3><center><b> Upload File Môn GDCD </b></center></h3>
		...
		<div class="row">
		    <table style="text-align: center;">
				...
				<tbody style="font-size: 15px">
				  <?php foreach ($filesgdcd as $file): ?>
				    <tr>
				      <td><?php echo $file['id']; ?></td>
				      <td><?php echo $file['name']; ?></td>
				      <td><?php echo floor($file['size'] / 1000) . ' KB'; ?></td>
				      <td><?php echo $file['downloads']; ?></td>
				      <td><a href="monGDCD.php?file_id=<?php echo $file['id'] ?>">Download</a></td>
				    </tr>
				  <?php endforeach;?>
