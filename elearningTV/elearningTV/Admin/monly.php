     ...
     <div class = "row">
        <aside class="col-sm-2">
          ...
          <article class="col-sm-10" >
		    ...
		    <div class="container">
		      <div class="row">
		        <form action="monly.php" method="post" enctype="multipart/form-data" >
		          <h3><center><b> Upload File Môn Lý </b></center></h3>
		...
		<div class="row">
		   <table style="text-align: center;">
				...
				<tbody>
				  <?php foreach ($filesly as $file): ?>
				    <tr>
				      <td><?php echo $file['id']; ?></td>
				      <td><?php echo $file['name']; ?></td>
				      <td><?php echo floor($file['size'] / 1000) . ' KB'; ?></td>
				      <td><?php echo $file['downloads']; ?></td>
				      <td><a href="monly.php?file_id=<?php echo $file['id'] ?>">Download</a></td>
				    </tr>
				  <?php endforeach;?>
